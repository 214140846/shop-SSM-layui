...
<form id="addrFormData">
	...
	<div class="layui-form-item">
		<label class="layui-form-label">取货人名称</label>
		<div class="layui-input-inline">
    ...
    <div class="layui-form-item">
    	<label class="layui-form-label">请选店铺择地区</label>
	    <div class="layui-input-inline">
	 ...
	 <div class="layui-form-item">
		...
		<div class="layui-input-inline">
			 <input type="text" name="addrZipcode" id="addrZipcode" required lay-verify="required" placeholder="请输入备注" value="" class="layui-input" />
		</div>			 
	</div>
			...
			$.ajax({
				...
				success:function(data){
					if(data!=null && data!=""){
						...
						"<th>电话</th><th>所在地区</th><th>店铺地址</th><th>操作</th></tr></thead><tbody>";
						for(var i=0;i<data.length;i++){
